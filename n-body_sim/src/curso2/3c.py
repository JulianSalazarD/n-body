...
class PointLight(Entity):
    ...
    def __init__(
        ...
        super().__init__(position, eulers=[0, 0, 0], scale=[1.0, 1.0, 1.0])
...
class Scene:
    ...
    def __init__(self):
        ...
        self.entities: dict[int, list[Entity]] = {
            ENTITY_TYPE["CUBE"]: [
                Cube(position=[0, 0, 0], eulers=[0, 0, 0], scale=[50, 50, 50]),
            ],
...
class GraphicsEngine:
    ...
    def _create_assets(self) -> None:
        ...
        self.materials: dict[int, Material] = {
            ENTITY_TYPE["CUBE"]: Material("gfx/img.png"),
        }
    ...
    def _set_onetime_uniforms(self) -> None:
        ...
        projection_transform = pyrr.matrix44.create_orthogonal_projection(
            left=-2500, right=2500, bottom=-2500, top=2500,
            near=1, far=10000, dtype=np.float32
        )
        glUniformMatrix4fv(
