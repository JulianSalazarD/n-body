...
from src.app.graphicsEngine import GraphicsEngine
from src.app.scene import Scene
...
class App:
    ...
    def run(self) -> None:
        ...
        while running:
            ...
            self.renderer.render(self.scene.camera, self.scene.entities)
    ...
    def _handle_mouse(self) -> None:
        ...
        self.scene.spin_camera(d_eulers)
