...
class Body:
    ...
    def draw(self, surface):
        pygame.draw.circle(surface, self.color, (self.position[0][0], self.position[0][1]), self.radius,
                           self.thickness)
    ...
    def move(self):
        self.velocity += (self.force / self.mass) * TIME_DELAY

        self.position += self.velocity * TIME_DELAY
